...
> **This is the V1 record — the TTS-only era of this repo.** The project has since gone
> beyond TTS and been renamed **Multilingual-Speech-Model**; see [README.md](README.md)
> for the current scope. Everything below is kept as it stood.
